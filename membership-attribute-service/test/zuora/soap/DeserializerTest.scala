...
import services.zuora.soap.models.Queries.{Account, Amendment, RatePlan, RatePlanCharge, Subscription}
import services.zuora.soap.models.{PaymentSummary, Result, errors}
import services.zuora.soap.models.Results.{AmendResult, Authentication, CreateResult, QueryResult, SubscribeResult, UpdateResult}
...
class DeserializerTest extends Specification {
  private implicit class ZuoraXmlFile(filename: String) {
    def as[T <: Result](implicit r: Reader[T]): Either[errors.Error, T] =
