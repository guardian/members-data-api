...
import services.zuora.soap.DateTimeHelpers.formatDateTime
import services.zuora.soap.readers.Query
...
class DateTimeHelpersTest extends Specification {
  ...
  "formatQuery" should {
    case class ZuoraQueryTest() extends services.zuora.soap.models.Query
