...
import scalaz.\/
import services.{CatalogService, HealthCheckableService, SubscriptionService, SupporterProductDataService}
...
class AccountControllerAcceptanceTest extends AcceptanceTest {
  ...
  "AccountController" should {
    "serve current user's products and data" in {
      ...
      subscriptionServiceMock.current[SubscriptionPlan.AnyPlan](eqTo(contact))(any) was called
