...
import models.subscription.subsv2.CatalogPlan._
...
class CatalogService(productIds: ProductIds, fetchCatalog: Future[String \/ JsValue], unsafeGet: Future[Catalog] => Catalog, stage: String)(implicit
    m: Monad[Future],
    ec: ExecutionContext,
) {
