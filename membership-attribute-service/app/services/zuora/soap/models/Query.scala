...
object Queries {
  ...
  case class ProductRatePlanCharge(id: String, name: String, productRatePlanId: String, billingPeriod: String) extends Query with Identifiable

  case class ProductRatePlanChargeTier(currency: String, price: Float, productRatePlanChargeId: String) extends Query
  ...
  case class RatePlan(id: String, name: String, productRatePlanId: String) extends Query with Identifiable
  ...
  case class Amendment(id: String, amendType: String, contractEffectiveDate: LocalDate, subscriptionId: String) extends Query with Identifiable
  ...
  case class InvoiceItem(
    ...
    /** @deprecated use models.subscription.Subscription with Paid */
    val annual = nextPaymentDate == serviceStartDate.plusYears(1)
  }

  case class PreviewInvoiceItem(
      price: Float,
      serviceStartDate: LocalDate,
      serviceEndDate: LocalDate,
      productId: String,
