...
trait PaymentService {
  ...
  @Deprecated def setPaymentCardWithStripeToken(accountId: AccountId, stripeToken: String, stripeService: StripeService): Future[Option[PaymentCardUpdateResult]]
  def setPaymentCardWithStripePaymentMethod(accountId: AccountId, stripePaymentMethodID: String, stripeService: StripeService): Future[Option[PaymentCardUpdateResult]]
