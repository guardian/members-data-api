...
case class PaymentDetails(subscriberId: String,
                          startDate: LocalDate,
...
object PaymentDetails {
  ...
  def apply(sub: Subscription[SubscriptionPlan.Paid], paymentMethod: Option[PaymentMethod], nextPayment: Option[Payment], lastPaymentDate: Option[LocalDate]): PaymentDetails = {
  ...
  case class PersonalPlan(name: String,
                          price: Price,
                          interval: String)
