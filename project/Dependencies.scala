...
object Dependencies {
  ...
  val sentryLogback = "io.sentry" % "sentry-logback" % "7.9.0"
  val identityAuth = "com.gu.identity" %% "identity-auth-play" % "4.25"
  ...
  val netty = "io.netty" % "netty-codec" % "4.1.109.Final"
  val nettyHttp = "io.netty" % "netty-codec-http" % "4.1.109.Final"
  val scalaXml = "org.scala-lang.modules" %% "scala-xml" % "2.1.0"
  val mockServer = "org.mock-server" % "mockserver-netty" % "5.15.0" % Test
  val mockitoScala = "org.mockito" %% "mockito-scala" % "1.17.31" % Test
  ...
  val apiDependencies = Seq(
    ...
    netty,
    nettyHttp,
    "com.google.guava" % "guava" % "33.2.0-jre", // until https://github.com/playframework/playframework/pull/10874
    unirest,
    mockServer,
    mockitoScala,
