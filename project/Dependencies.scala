...
object Dependencies {
  ...
  val sentryLogback = "io.sentry" % "sentry-logback" % "7.11.0"
  ...
  val netty = "io.netty" % "netty-codec" % "4.1.111.Final"
  val nettyHttp = "io.netty" % "netty-codec-http" % "4.1.111.Final"
  ...
  val apiDependencies = Seq(
    ...
    netty,
    nettyHttp,
    "com.google.guava" % "guava" % "33.2.1-jre", // until https://github.com/playframework/playframework/pull/10874
    unirest,
    mockServer,
    mockitoScala,
